...
size_t LetterboxOMeter::getLetterboxWidth() {
...
size_t LetterboxOMeter::getLetterboxHeight() {
    return mLetterboxHorizontalBarHeight;
}

Geometry LetterboxOMeter::getHorizontalBar(size_t height, size_t topOffset) {
    return Geometry(mScreenWidth, height, mScreenXOffset, mScreenYOffset + topOffset);
}

Magick::Geometry LetterboxOMeter::getVerticalBar(size_t width, size_t leftOffset) {
